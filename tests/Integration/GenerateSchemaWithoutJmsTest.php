...
final class GenerateSchemaWithoutJmsTest extends TestCase
{
    ...
    public function testSchemaGenerationWithoutJms(): void
    {
        ...
        if (getenv('UPDATE_SNAPSHOTS') === '1') {
            file_put_contents(
                __DIR__ . '/Expected/testSchemaGenerationWithoutJms.json',
